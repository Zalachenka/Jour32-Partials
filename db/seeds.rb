...
10.times do
  my_event = Event.create!(start_date: Faker::Date.forward(50), duration: 5, title: Faker::Book.title, description: Faker::TvShows::SiliconValley.quote, price: rand(1..1000), location: Faker::Address.city, admin: User.all[rand(0..9)])
end
puts "Events created!"
